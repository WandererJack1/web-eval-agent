...
1. Pre-requisites (typically not needed):
 ...
 - jq: `brew install jq` 
2. Run the installer after [getting an api key (free)](https://www.operativelabs.xyz)
...
1. Get your API key at operativelabs.xyz
...
2. `curl -LSf https://operativelabs.xyz/install.sh -o install.sh && bash install.sh && rm install.sh`
3. Get your API key at operativelabs.xyz
...
Built with <3 @ [operativelabs.xyz](https://www.operativelabs.xyz)
